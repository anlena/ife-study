---
title: Rem布局的原理解析及实例
date: 2017-10-26 10:11:17
tags:
---

# Rem布局的原理解析(可用)

[原文地址](https://zhuanlan.zhihu.com/p/30413803)
...
有些人提出用em来做弹性布局页面，但其复杂的计算让人诟病，甚至有人专门做了个px和em的[计算器**](http://link.zhihu.com/?target=https%3A//vasilis.nl/nerd/code/emcalc/)，不同节点像素值对应的em值，o(╯□╰)o
...
页面效果如下，完整的例子在[这里**](http://link.zhihu.com/?target=http%3A//yanhaijing.com/rem/rem-and-js.html)
...
- [从网易与淘宝的font-size思考前端设计稿与工作流**](http://link.zhihu.com/?target=http%3A//www.cnblogs.com/lyzg/p/4877277.html)
- [移动web适配之rem**](http://link.zhihu.com/?target=https%3A//www.nihaoshijie.com.cn/index.php/archives/593/)
- [使用 rem 提供一致的字体大小](http://link.zhihu.com/?target=http%3A//harttle.com/2016/12/20/rem-and-accessibility.html)